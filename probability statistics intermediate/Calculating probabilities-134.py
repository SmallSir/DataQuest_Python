...
prob_8 = find_outcome_combinations(10, 8) * find_combination_probability(10, 8)
prob_9 = find_outcome_combinations(10, 9) * find_combination_probability(10, 9)
prob_10 = find_outcome_combinations(10, 10) * find_combination_probability(10, 10)
