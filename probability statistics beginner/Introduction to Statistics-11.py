...
male_savings_list = [i for i in range(len(gender)) if gender[i] == 'male']
male_saving = [savings[male_savings_list[i]] for i in range(len(male_savings_list))]
male_savings = sum(male_saving)/len(male_saving)


female_savings_list = [i for i in range(len(gender)) if gender[i] == 'female']
female_saving = [savings[female_savings_list[i]] for i in range(len(female_savings_list))]
female_savings = sum(female_saving)/len(female_saving)
